...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Привет?") action Start()
        ...
        textbutton _("Настроечки") action ShowMenu("preferences")
        ...
        textbutton _("Это что?") action ShowMenu("about")

        if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):

            ## Help isn't necessary or relevant to mobile devices.
            textbutton _("Хепл") action ShowMenu("help")
