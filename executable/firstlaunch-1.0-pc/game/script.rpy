# Я не несу ответственности за названия, имена и нецензурную лексику. 
# Весь сценарий был написан с отсылками на нишевые шутки,поэтому прошу пропустить это 
init:
    transform flip:
        xzoom -1.0
    ...
    label the_question: 
        ...
        menu:
            "Stay":           
                ...
                call ebir_comes from _call_ebir_comes
            "Leave":
